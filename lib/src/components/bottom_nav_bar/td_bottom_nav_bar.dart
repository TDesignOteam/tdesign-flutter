...
class _TDBottomNavBarState extends State<TDBottomNavBar> {
  ...
  Widget build(BuildContext context) {
    var isOutlineType = widget.outlineType == TDBottomNavBarOutlineType.capsule;
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        return Container(
            ...
            margin: isOutlineType
                ? const EdgeInsets.symmetric(horizontal: 16)
                : null,
            decoration: BoxDecoration(
                color: Colors.white,
                borderRadius: isOutlineType ? BorderRadius.circular(56) : null,
                border: widget.showTopBorder!
                    ? Border.all(color: TDTheme.of(context).grayColor3)
                    : null,
                boxShadow:
                    isOutlineType ? TDTheme.of(context).shadowsTop : null),
...
class TDBottomNavBarItemWithBadge extends StatelessWidget {
        ...
        child: Stack(
          ...
          children: [
            ...
            Container(
                ...
                child: _constructItem(context, badgeConfig)),
            // )
          ],
        ),
      ),
  ...
  Widget _constructItem(BuildContext context, BadgeConfig? badgeConfig) {
