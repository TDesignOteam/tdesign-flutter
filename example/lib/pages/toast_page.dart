...
class _ToastPageState extends State<ToastPage> {
  ...
  Widget _widget() {
    return ListView(children: [
      ...
      PageUtil.outlinedButton('短文本轻提示', () => Toast.toast('轻提示内容')),
      ...
      PageUtil.outlinedButton('成功', () => Toast.success()),
      PageUtil.outlinedButton('警告', () => Toast.fail()),
      PageUtil.outlinedButton('加载', () => Toast.loading()),
      PageUtil.outlinedButton('自定义图标', () => Toast.info()),
      PageUtil.buildSubTitle('图标加文本轻提示'),
      PageUtil.outlinedButton('成功', () => Toast.success(message: '成功文案')),
      PageUtil.outlinedButton('警告', () => Toast.fail(message: '失败文案')),
      PageUtil.outlinedButton('加载', () => Toast.loading(message: '加载')),
      PageUtil.outlinedButton('自定义图标', () => Toast.info(message: '自定义图标')),
      PageUtil.outlinedButton('超长警告', () => Toast.fail(message: '般若波罗蜜多心经')),
      ...
      PageUtil.outlinedButton('带背景遮罩', () => Toast.toast('轻提示内容', showOverlay: true)),
    ]);
  }
}
